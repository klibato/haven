...
export function LoginForm({ onSwitchToRegister }: LoginFormProps) {
  ...
  return (
    <div className="w-full max-w-md bg-bg-secondary rounded-lg p-8">
      <h1 className="text-2xl font-bold text-text-normal text-center mb-2">Welcome back!</h1>
      <p className="text-text-muted text-center mb-6">We're so excited to see you again!</p>
      ...
      <p className="text-sm text-text-muted mt-4">
        Need an account?{" "}
        <button onClick={onSwitchToRegister} className="text-text-link hover:underline">
          Register
        </button>
      </p>
    </div>
